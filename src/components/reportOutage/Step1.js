...
import { selectReportType, parseAddress, addressLookup, decrementStep } from '../../actions.js'
      ...
      <div className="container-fluid grid-950px PADD20PX">
        ...
        <form className="report-trouble-form center-950px-block" onSubmit={this.handleSubmit}>
          <div className="formContent PADDBOX dte-white-bkg">
            <div className="row">
              <div className="col-xs-10 col-md-6 col-xs-offset-1 col-md-offset-3">Enter the information of the location where you are experiencing a power problem.</div>
            </div>
            <div className="row">
              <div className="nav nav-pills col-xs-10 col-md-6 col-xs-offset-1 col-md-offset-3 PADD0">
                <div className={reportType == 'addressReport' ? ('col-xs-6 active') : 'col-xs-6'}>
                  <a data-toggle="tab" href="#addressReport" title="addressReport" onClick={this.handleChangeTab}>Address</a></div>
                <div className={reportType == 'phoneReport' ? 'col-xs-6 active' : 'col-xs-6'}>
                  <a data-toggle="tab" href="#phoneReport" title="phoneReport" onClick={this.handleChangeTab}>Phone</a></div>
              </div>
            </div>
            <div className="row">
